...
NAV_TREE: dict[str, dict[str, object]] = {
    ...
    "env": {
        ...
        "children": {
            ...
            "logs": {"desc": "Логи сервисов (--grep, -f, --tail)", "children": {}},
            "restart": {"desc": "Перезапустить сервис(ы) (--recreate для нового конфига)", "children": {}},
            "reload": {"desc": "Алиас restart --recreate (применить новый Caddyfile/env)", "children": {}},
            "rebuild": {"desc": "Пересборка образов", "children": {}},
            "status": {"desc": "Dashboard стека (state/health/uptime/URL)", "children": {}},
